...
- (void)startBroadcastWithAppGroup:(NSString *)appGroup sampleHandler:(RPBroadcastSampleHandler *)sampleHandler {
    ...
    CFNotificationCenterAddObserver(CFNotificationCenterGetDarwinNotifyCenter(),
                                    ...
                                    onBroadcastFinish,
                                    (CFStringRef)@"ZG_BROADCAST_FINISH_NOTIFICATION",
                                    NULL,
...
- (void)loginRoom {
    ...
    [[ZegoExpressEngine sharedEngine] loginRoom:self.roomID user:[ZegoUser userWithUserID:self.userID userName:self.userName] config:config];
}
...
- (void)syncParametersFromMainAppProcess {
    ...
    self.token = [self.userDefaults valueForKey:@"ZG_SCREEN_CAPTURE_ROOM_TOKEN"];
