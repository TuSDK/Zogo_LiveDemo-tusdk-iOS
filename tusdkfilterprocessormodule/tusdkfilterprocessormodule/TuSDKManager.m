...
- (UIView *)configFilterPanelView
{
    ...
    _filterPanelView = [[TuFilterPanelView alloc] initWithFrame:CGRectMake(0, KScreenHeight - 246 - lsq_NAV_BAR_HEIGHT - lsq_STATES_BAR_HEIGHT, KScreenWidth, 246)];
...
- (UIView *)configStickerPanelView
{
    ...
    _stickerPanelView = [[TuStickerPanelView alloc] initWithFrame:CGRectMake(0, KScreenHeight - 200 - lsq_NAV_BAR_HEIGHT - lsq_STATES_BAR_HEIGHT, KScreenWidth, 200)];
...
- (UIView *)configBeautyPanelView
{
    ...
    _beautyPanelView = [[TuBeautyPanelView alloc] initWithFrame:CGRectMake(0, KScreenHeight - 276 - lsq_NAV_BAR_HEIGHT - lsq_STATES_BAR_HEIGHT, KScreenWidth, 276)];
