...
//    CVPixelBufferRef newPixelBuffer  = [[TuSDKManager sharedManager] syncProcessPixelBuffer:buffer ];
    CVPixelBufferRef newPixelBuffer = [[TuSDKManager sharedManager] syncProcessPixelBuffer:buffer timeStamp:0];
//    [self renderWithCVPixelBuffer:newPixelBuffer];
